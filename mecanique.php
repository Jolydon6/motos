        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Enregistrer</button>
                </div>
           ...
           Agent non ajouté!!
                                    ...
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">Véhicules</label>
                                        <input type="text" class="form-control" name="nom_agent" id="recipient-name" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">Intervation</label>
                                        <input type="text" class="form-control" name="nom_agent" id="recipient-name" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">Pannes</label>
                                        <input type="text" class="form-control" name="nom_agent" id="recipient-name" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">Pièces changées</label>
                                        <input type="text" class="form-control" name="nom_agent" id="recipient-name" required>
                                    </div>
                                    <div class="mb-3">
